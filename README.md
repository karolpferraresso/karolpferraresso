...
Atualmente, curso o 2º ano do Ensino Médio no **SESI** em conjunto com a formação técnica em **Desenvolvimento de Sistemas pelo SENAI**. Essa jornada tem sido fundamental para fortalecer meu raciocínio lógico e minhas habilidades técnicas.

---

### 🛠️ Minhas Habilidades e Aprendizados

* **Tecnologia:** Foco em lógica de programação e desenvolvimento de softwares (SENAI).
* **Idiomas:** Inglês em constante aprimoramento.
* **Soft Skills:** Desenvolvimento de visão de carreira e responsabilidade profissional através do curso "Abrindo Portas".

### 🎵 Além do Código

Acredito que a disciplina vem de diferentes áreas da vida:
* **Música:** Estudei por dois anos no **UNASP (Hortolândia)**, o que me trouxe uma base sólida em formação musical.
* **Esportes:** Minha trajetória na natação e no balé me ensinou o valor do foco. Hoje, mantenho essa constância através da **musculação**, priorizando saúde e bem-estar.
